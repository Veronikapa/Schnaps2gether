...
public class Spielfeld2 extends Activity implements GameEnd.GameEndDialogListener, PopupMenu.OnMenuItemClickListener {
  ...
  /*  private Button buttonKarte1;
    ...
    private ImageButton imagebuttonEigeneKarte;
    private ImageButton imagebuttonGegnerischeKarte;
    private ImageButton imagebuttonTrumpfkarte;



    private ArrayList<ImageButton> handkartenImageButtons;
